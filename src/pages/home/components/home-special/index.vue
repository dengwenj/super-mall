...
import { getSpecial } from '@/services/api/home'
...
const [homeSpecialRef, special] = useLazyData<ISpecial>(getSpecial)
</script>

<template>
  <HomePanel title="最新专题">
    <template v-slot:right><WwMore /></template>
    <div class="special-list" ref="homeSpecialRef">
